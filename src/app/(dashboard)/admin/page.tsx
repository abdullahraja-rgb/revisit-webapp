...
import { ShieldAlert, UserPlus, Building, Users, ShieldCheck, Edit, Eye, Activity } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <div className="flex items-center gap-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-[#4c4c4c]/70 font-medium text-pretty">
                    Manage practitioners, organizations, and care groups with precision
                  </p>
                </div>
              </div>
            </div>
        ...
        {isAdmin ? (
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative p-8">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-[#005fee] hover:bg-[#3583f7] text-white font-semibold py-3 px-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 text-sm flex items-center justify-center gap-2 transform hover:-translate-y-0.5"
                  >
                    <UserPlus className="h-4 w-4" /> Create Practitioner
                  </button>
                  <button
                    onClick={handleManagePractitioners}
                    className="w-full bg-white border border-[#005fee]/20 hover:bg-[#005fee]/5 text-[#005fee] font-semibold py-3 px-6 rounded-2xl hover:shadow-md transition-all duration-300 text-sm flex items-center justify-center gap-2 transform hover:-translate-y-0.5"
                  >
              ...
              <div className="relative p-8">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-[#3583f7] hover:bg-[#6aa6ff] text-white font-semibold py-3 px-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 text-sm transform hover:-translate-y-0.5"
                  >
                  ...
                  <button
                    ...
                    className="w-full bg-white border border-[#3583f7]/20 hover:bg-[#3583f7]/5 text-[#3583f7] font-semibold py-3 px-6 rounded-2xl hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2 text-sm transform hover:-translate-y-0.5"
                  >
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-white shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border border-[#005fee]/10 md:col-span-2 lg:col-span-1">
              ...
              <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-[#6aa6ff]/5 transform rotate-45 rounded-2xl"></div>
              ...
              <div className="relative p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-[#4c4c4c]">Care Groups</h2>
                    <p className="text-[#4c4c4c]/60 mt-1 text-sm">Manage care groups</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <button
                    onClick={handleCreateCareGroup}
                    className="w-full bg-[#005fee] hover:bg-[#3583f7] text-white font-semibold py-3 px-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-center gap-2 text-sm transform hover:-translate-y-0.5"
                  >
                  ...
                  <button
                    ...
                    className="w-full bg-white border border-[#005fee]/20 hover:bg-[#005fee]/5 text-[#005fee] font-semibold py-3 px-6 rounded-2xl hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2 text-sm transform hover:-translate-y-0.5"
                  >
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-white shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border border-[#6aa6ff]/10 md:col-span-2 lg:col-span-3">
              ...
              <div className="relative p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-[#4c4c4c]">Organization Administrators</h2>
                    <p className="text-[#4c4c4c]/60 mt-1">Create and manage organization administrators</p>
                  </div>
                </div>
                <button
                  onClick={handleCreateOrgAdmin}
                  className="bg-[#6aa6ff] hover:bg-[#005fee] text-white font-semibold py-3 px-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 flex items-center gap-2 text-sm transform hover:-translate-y-0.5"
                >
